...
public class ConcreteSubject implements Subject, ApplicationContextAware, BeanNameAware, BeanFactoryAware, InitializingBean, ApplicationEventPublisherAware {
	...
	private List<ObserverHelper> observers = new ArrayList<ObserverHelper>();
	...
	@Override
	public List<ObserverHelper> getObservers() {
		return observers;
	}

	@Override
	public void setObservers(List<ObserverHelper> observers) {
		this.observers = observers;
	}

	@Override
	public void addObserver(ObserverHelper observer) {
	...
	public void notifyObservers(String message) {
		for (ObserverHelper observer : getObservers()) {
