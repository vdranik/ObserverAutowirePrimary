...
@Component
@Primary
public class ConcreteObserver2 implements ObserverHelper, ApplicationContextAware, BeanNameAware, BeanFactoryAware, InitializingBean, ApplicationListener<ContextClosedEvent> {
